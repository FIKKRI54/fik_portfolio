    ...
    return (
        <section id="about" className="min-h-screen flex items-center justify-center py-20 px-4 md:px-20 relative z-10 -mt-8" style={{ backgroundColor: '#E8ECED' }}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto w-full">
                <div className="text-left bg-white/50 p-6 rounded-3xl border border-white/60 shadow-sm backdrop-blur-md md:bg-transparent md:p-0 md:border-none md:shadow-none md:backdrop-blur-none">
                ...
                <div className="h-[500px] md:h-[600px] flex items-center justify-center relative bg-neutral-950 rounded-3xl border border-neutral-800 overflow-hidden">
                    <Lanyard />
                </div>
            </div>
        </section>
